...
public class CaptchaHelper {
     ...
     * */
    private static ImageCaptchaService generatorCaptchaService(){
        ...
        return new DefaultManageableImageCaptchaService(new FastHashMapCaptchaStore(),gce,180,200000,75000);
    }
}
